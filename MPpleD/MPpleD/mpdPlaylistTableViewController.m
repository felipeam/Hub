...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.row <[tableView numberOfRowsInSection:0])
    {
        ...
        char* szText = (char*)mpd_song_get_tag(nextSong, MPD_TAG_ARTIST, 0);
        if (szText == nil) {
            szText = "Unkown Artist";
        }
        [[cell detailTextLabel] setText:[[NSString alloc] initWithUTF8String:szText]];
        
        szText = (char*)mpd_song_get_tag(nextSong, MPD_TAG_TITLE, 0);
        if (szText == nil) {
            szText = "Unkown Title";
        }
        [[cell textLabel] setText:[[NSString alloc] initWithUTF8String:szText]];
