...
#import "mpdPlaylistsViewController.h"

@interface mpdPlaylistsViewController ()

@end

@implementation mpdPlaylistsViewController
...
{
    static NSString *CellIdentifier = @"playlistsItem";
